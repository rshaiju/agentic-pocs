...
import gradio as gr
from data_processor import (GET_FILE_CONTENT_TOOLS_JSON, GET_FILES_TOOLS_JSON,
...
"""
tools = [
    {"type": "function", "function": GET_FILES_TOOLS_JSON},
    {"type": "function", "function": GET_FILE_CONTENT_TOOLS_JSON},
]
...
def main():
    gr.ChatInterface(
        fn=chat,
        title="Tour Guide",
        description="Ask questions about tour destinations.",
