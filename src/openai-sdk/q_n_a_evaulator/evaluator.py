...
system_msg = (
    "You are a helpful assistant who can evaluate the answers provided by a human to questions. "
...
class Evaluator(BaseAgent):
    ...
    def evaluate_answer(self, question: str, answer: str):
        return self.chat(
            f"Please evaluate the following answer to the question '{question}': {answer}"
        )
